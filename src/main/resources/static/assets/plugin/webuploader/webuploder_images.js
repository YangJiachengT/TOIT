jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        server: ctx+'/attach/upload/doImageUpload',
        fileNumLimit: 50,
        fileSizeLimit: 2500 * 1024 * 1024,    // 250 M
...
//                console.log( file.statusText );
    ...
    uploader.on( 'uploadAccept', function(file, result ) {
    	if(result.state=="ok"){
    		parent.uploadFileComplete(attachField, attachImage,result.data.attachId,result.data.fileName,result.data.fileSuffix,2);
    		//如果上传完毕，则关闭弹窗
